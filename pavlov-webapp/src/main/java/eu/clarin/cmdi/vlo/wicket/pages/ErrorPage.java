...
public class ErrorPage extends VloBasePage {
    ...
    private String getDescriptionForError(ErrorType type) {
        switch (type) {
            case PAGE_NOT_FOUND:
                return "<p>The requested page does not exist in PAVLOV-1.0!</p>";
            case DOCUMENT_NOT_FOUND:
                return "<p>The requested record does not exist (anymore) in PAVLOV-1.0. "
                        ...
                        + "<li>If you think the record should be present in PAVLOV-1.0 but cannot find it, please "
                        + "contact the maintainers PAVLOV-1.0 using the contact information in the 'About' page.</li>"
                        + "</ul>";
            case UNKNOWN_ERROR:
                return "<p>An unknown error has occurred! If this keeps happening, please notify the maintainers "
                        + "of PAVLOV-1.0 using the contact information in the 'About' page.</p>";
            default:
                return null;
        }
    }
