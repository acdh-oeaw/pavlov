...
public class VloBasePage<T> extends GenericWebPage<T> {
    ...
    public final static String DEFAULT_PAGE_TITLE = "PARTHENOS VLO VERSION-1.0";
    ...
    private Component createHeaderMenu(String id) {
        ...
        navbar.setBrandName(Model.of("<i class=\"fa fa-globe\" aria-hidden=\"true\"></i> PAVLOV-1.0"));

        // link to CLARIN website
        final Component clarinLink = new NavbarExternalLink(Model.of("https://parthenos.d4science.org/")) {
            @Override
