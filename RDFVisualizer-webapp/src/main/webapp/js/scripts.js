...
/******************* Set to local storage docId value **********************/
if (!(_GET.docId === undefined)) {
   // var folderpath = _GET.filename;
    localStorage.setItem("docId", _GET.docId);         
}
...
function getModel(resource) {
    ...
    var docId = localStorage.getItem("docId"); // get docId if exists from localstorage  
