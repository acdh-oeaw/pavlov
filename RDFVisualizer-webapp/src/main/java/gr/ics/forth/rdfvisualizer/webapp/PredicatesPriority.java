    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (subject_type != null) {
                ...
                //String properties_xml = props.getProperty("priorities_xml").trim(); //loading via classloader
                String properties_xml = getClass().getClassLoader().getResource("properties.xml").getFile();
